...
public class OrderServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if(customer == null){
            ...
            List<Order> list = orderDao.getAll(customer);
            String from_raw = request.getParameter("fromdate");
            String to_raw = request.getParameter("todate");
            Date from,to;
            try{
                
               if(from_raw == null || from_raw.equals("")){
                   from = null;
               }else
                   from = Date.valueOf(from_raw);
               
               if(to_raw == null || to_raw.equals("")){
                   to = null;
               }else
                   to = Date.valueOf(to_raw);
               
               List<Order> orders = orderDao.searchOrder(customer,from, to);
